...
export function CustomerForm({ onSave, onCancel, initialCustomer }: CustomerFormProps) {
  const form = useForm<CustomerFormValues>({
    ...
    defaultValues: {
      ...
      contactName: initialCustomer?.contactName || initialCustomer?.contact_name || "",
      email: initialCustomer?.email || "",
      phone: initialCustomer?.phone || "",
      address: initialCustomer?.address || "",
      notes: initialCustomer?.notes || "",
      isActive:
        initialCustomer?.isActive !== undefined
          ? initialCustomer.isActive
          : initialCustomer?.is_active !== undefined
