...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'bh_timesheets'),
...
# Custom serializer to exclude username during registration
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for Ben Heath Timesheets application',
    'VERSION': '1.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'Timesheets', 'description': 'Timesheet management operations'},
        {'name': 'Timesheet Details', 'description': 'Timesheet detail management operations'},
    ],
    'SECURITY': [
    ...
    'SWAGGER_UI_DIST': '/drf_spectacular_sidecar/swagger-ui-dist',
